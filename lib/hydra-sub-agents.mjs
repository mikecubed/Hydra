...
export const BUILT_IN_SUB_AGENTS = {
  'security-reviewer': {
    ...
    rolePrompt: `You are a security review specialist. Your methodology:
...
- Dependency audit notes (if applicable)`,
  ...
  'test-writer': {
    ...
    rolePrompt: `You are a test strategy specialist using Node.js native test runner (node:test + node:assert/strict).
...
- No external test frameworks — pure Node.js built-ins`,
  ...
  'doc-generator': {
    ...
    rolePrompt: `You are a documentation specialist. You read code to produce docs, not the reverse.
...
- Match the project's existing documentation style`,
  ...
  researcher: {
    ...
    rolePrompt: `You are a research and investigation specialist. Your methodology:
...
- Open questions (if any remain)`,
  ...
  'evolve-researcher': {
    ...
    rolePrompt: `You are an evolution topic researcher for the Hydra self-improvement pipeline. Your job:
...
- Recommended execution order`,
  ...
  'failure-doctor': {
    ...
    rolePrompt: `You are a failure diagnosis specialist for the Hydra multi-agent orchestration system. Your methodology:
