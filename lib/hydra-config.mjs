...
const DEFAULT_CONFIG = {
  ...
  roles: {
    ...
    investigator:   { agent: 'codex', model: 'gpt-5.3-codex', reasoningEffort: 'high' },
  ...
  recommendations: {
    concierge:      { models: ['gpt-5.2-codex', 'gpt-5.3-codex', 'claude-sonnet-4-5-20250929'], reasoningEffort: 'xhigh', note: 'Needs fast streaming + broad knowledge for chat UX' },
    investigator:   { models: ['gpt-5.3-codex', 'gpt-5.3'], reasoningEffort: 'high', note: 'Needs strong reasoning for failure diagnosis' },
