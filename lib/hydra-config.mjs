...
const DEFAULT_CONFIG = {
  ...
  models: {
    ...
    codex:  { default: 'codex-5.3', fast: 'o4-mini', cheap: 'o4-mini', active: 'default' },
  ...
  aliases: {
    ...
    codex:  { gpt5: 'gpt-5', 'gpt-5': 'gpt-5', 'codex-5.3': 'codex-5.3', 'gpt-5.3': 'codex-5.3', 'o4-mini': 'o4-mini', o4mini: 'o4-mini' },
  ...
  recommendations: {
    ...
    architect:      { models: ['claude-opus-4-6', 'codex-5.3'], reasoningEffort: null, note: 'Complex planning — use strongest available model' },
    ...
    implementer:    { models: ['codex-5.3', 'claude-sonnet-4-5-20250929'], reasoningEffort: null, note: 'Fast execution with good instruction following' },
  },
  agents: {
    subAgents: {
      enabled: true,
