...
export async function executeAgent(agent, prompt, opts = {}) {
  ...
  // Route Gemini to executeGeminiDirect via a local sentinel — avoids a circular
  // import (hydra-agents.mjs ↔ agent-executor.mjs) and never mutates the shared
  // registry definition. When the Gemini CLI bug is fixed, delete this block and
