...
Usage:
  node lib/hydra-setup.mjs setup [--force] [--uninstall]
  node lib/hydra-setup.mjs init  [--project-name=Name]
  node lib/hydra-setup.mjs --help
...
Options:
  --force       Overwrite existing MCP registrations
...
export async function main(argv) {
  ...
  const { subcommand, flags } = parseSetupArgs(effectiveArgv);
...
async function runInit(flags) {
  ...
  if (fs.existsSync(hydraMdPath)) {
    ...
    console.log(`Created HYDRA.md for "${projectName}".`);
  }
