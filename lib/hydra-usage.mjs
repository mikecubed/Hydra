...
import { setActiveModel, AGENT_NAMES, getModelSummary, getAgent } from './hydra-agents.mjs';
...
function agentBadgeCompact(agent) {
  const map = {
    ...
    claude: { icon: '\u2666', color: isTruecolor ? (str) => `\x1b[38;2;232;134;58m${str}\x1b[39m` : pc.yellow },
  };
