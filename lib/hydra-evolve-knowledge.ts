...
function knowledgePath(evolveDir: string) {
 ...
 */
export function loadKnowledgeBase(evolveDir: string): KnowledgeBase {
 ...
 */
function isTooSimilar(existingEntries: KBEntry[], newFinding: string, threshold = 0.7) {
 ...
 */
export function searchEntries(kb: KnowledgeBase, query?: string, tags?: string[]): KBEntry[] {
