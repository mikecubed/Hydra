 ...
 *   - At 70% budget: hand off remaining tasks to Codex 5.3 (gpt-5.3-codex)
...
/** The Codex model used for budget-saving handoff. */
export const CODEX_HANDOFF_MODEL = 'gpt-5.3-codex';
