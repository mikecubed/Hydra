...
export const ROLE_DEFAULTS = {
  architect: {
    ...
    models: ['claude-sonnet-4-6', 'claude-opus-4-6', 'gpt-5.2-codex'],
  ...
  implementer: {
    agent: 'codex',
    model: null,    // uses agent default (gpt-5.2-codex)
    reasoningEffort: null,
    models: ['gpt-5.2-codex', 'claude-sonnet-4-5-20250929'],
...
export const AGENT_PRESETS = {
  ...
  codex:  { default: 'gpt-5.2-codex',  fast: 'o4-mini',                    cheap: 'o4-mini' },
