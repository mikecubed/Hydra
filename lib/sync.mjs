...
import { getCurrentBranch as getCurrentBranchGit } from './hydra-shared/git-ops.mjs';
...
function detectVersion(name, customCommand) {
  ...
  if (needsShell) {
    const r = spawnSyncCapture(command, [], { cwd: ROOT, encoding: 'utf8', windowsHide: true, shell: true });
